...
Throughout this project, the Jetson Nano was used as the base station, we used the UART pins 8 and 10 for TX and RX which was located at the port /dev/ttyTHS1
